...
Shader "FSGShaders/sha_OverTime"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin][Header(LinesTxtr______________________________)][Header()][NoScaleOffset]_LinesPattern("LinesPattern", 2D) = "white" {}
		_LinesTextureCoordination("LinesTextureCoordination", Vector) = (1,1,0,0)
		_LinesTextureSpeed("LinesTextureSpeed", Vector) = (0,0,0,0)
		_LinesOffset("LinesOffset", Vector) = (0.5,0.5,0,0)
		_LinesSize("LinesSizeNoise", Float) = 0
		...
		_Mask("Mask", 2D) = "white" {}
		[ASEEnd]_AlphaPower("AlphaPower", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _NoiseTO;
			float4 _Mask_ST;
			float2 _LinesTextureCoordination;
			float2 _LinesTextureSpeed;
			float2 _LinesOffset;
			float2 _NoiseSpeed;
			float _NoiseUv;
			float _LinesSize;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 temp_output_47_0_g45 = _LinesTextureSpeed;
				float2 texCoord22 = IN.ase_texcoord3.zw * float2( 1,1 ) + _LinesOffset;
				float2 temp_output_31_0_g45 = ( texCoord22 - float2( 1,1 ) );
				...
				float4 tex2DNode21 = tex2D( _LinesPattern, ( ( (tex2D( _Sampler6026, ( appendResult10_g45 + appendResult24_g45 ) )).rg * 1.0 ) + ( _LinesTextureCoordination * appendResult58_g45 ) ) );
				float4 break44_g41 = _NoiseTO;
				float4 appendResult41_g41 = (float4(break44_g41.x , break44_g41.y , 0.0 , 0.0));
				float4 break45_g41 = float4( 0,0,0,0 );
				float4 appendResult43_g41 = (float4(( break45_g41.z - _NoiseUv ) , break45_g41.w , 0.0 , 0.0));
				float2 texCoord51_g41 = IN.ase_texcoord3.zw * appendResult41_g41.xy + appendResult43_g41.xy;
				float2 panner46_g41 = ( ( _TimeParameters.x ) * _NoiseSpeed + texCoord51_g41);
				float simplePerlin2D16 = snoise( panner46_g41*_LinesSize );
				simplePerlin2D16 = simplePerlin2D16*0.5 + 0.5;
				float4 temp_cast_2 = (simplePerlin2D16).xxxx;
				float4 clampResult13 = clamp( ( tex2DNode21 + ( tex2DNode21 - temp_cast_2 ) ) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				
				float2 uv_Mask = IN.ase_texcoord3.xy * _Mask_ST.xy + _Mask_ST.zw;
				float4 clampResult30 = clamp( ( clampResult13 - tex2D( _Mask, uv_Mask ) ) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( _LinesColor * clampResult13 ).rgb;
				float Alpha = ( clampResult30 * _AlphaPower ).r;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 appendResult24_g45 = (float2((panner18_g45).x , (panner19_g45).y));
				float2 temp_output_47_0_g45 = _LinesTextureSpeed;
				float2 texCoord22 = IN.ase_texcoord2.zw * float2( 1,1 ) + _LinesOffset;
				float2 temp_output_31_0_g45 = ( texCoord22 - float2( 1,1 ) );
				float2 appendResult39_g45 = (float2(frac( ( atan2( (temp_output_31_0_g45).x , (temp_output_31_0_g45).y ) / TWO_PI ) ) , length( temp_output_31_0_g45 )));
				float2 panner54_g45 = ( ( (temp_output_47_0_g45).x * _TimeParameters.x ) * float2( 1,0 ) + appendResult39_g45);
				float2 panner55_g45 = ( ( _TimeParameters.x * (temp_output_47_0_g45).y ) * float2( 0,1 ) + appendResult39_g45);
				...
				float4 break45_g41 = float4( 0,0,0,0 );
				float4 appendResult43_g41 = (float4(( break45_g41.z - _NoiseUv ) , break45_g41.w , 0.0 , 0.0));
				float2 texCoord51_g41 = IN.ase_texcoord2.zw * appendResult41_g41.xy + appendResult43_g41.xy;
				float2 panner46_g41 = ( ( _TimeParameters.x ) * _NoiseSpeed + texCoord51_g41);
				float simplePerlin2D16 = snoise( panner46_g41*_LinesSize );
				simplePerlin2D16 = simplePerlin2D16*0.5 + 0.5;
				float4 temp_cast_2 = (simplePerlin2D16).xxxx;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 appendResult24_g45 = (float2((panner18_g45).x , (panner19_g45).y));
				float2 temp_output_47_0_g45 = _LinesTextureSpeed;
				float2 texCoord22 = IN.ase_texcoord.zw * float2( 1,1 ) + _LinesOffset;
				float2 temp_output_31_0_g45 = ( texCoord22 - float2( 1,1 ) );
				float2 appendResult39_g45 = (float2(frac( ( atan2( (temp_output_31_0_g45).x , (temp_output_31_0_g45).y ) / TWO_PI ) ) , length( temp_output_31_0_g45 )));
				float2 panner54_g45 = ( ( (temp_output_47_0_g45).x * _TimeParameters.x ) * float2( 1,0 ) + appendResult39_g45);
				float2 panner55_g45 = ( ( _TimeParameters.x * (temp_output_47_0_g45).y ) * float2( 0,1 ) + appendResult39_g45);
				...
				float4 break45_g41 = float4( 0,0,0,0 );
				float4 appendResult43_g41 = (float4(( break45_g41.z - _NoiseUv ) , break45_g41.w , 0.0 , 0.0));
				float2 texCoord51_g41 = IN.ase_texcoord.zw * appendResult41_g41.xy + appendResult43_g41.xy;
				float2 panner46_g41 = ( ( _TimeParameters.x ) * _NoiseSpeed + texCoord51_g41);
				float simplePerlin2D16 = snoise( panner46_g41*_LinesSize );
				simplePerlin2D16 = simplePerlin2D16*0.5 + 0.5;
				float4 temp_cast_2 = (simplePerlin2D16).xxxx;
				...
				surfaceDescription.Alpha = ( clampResult30 * _AlphaPower ).r;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 appendResult24_g45 = (float2((panner18_g45).x , (panner19_g45).y));
				float2 temp_output_47_0_g45 = _LinesTextureSpeed;
				float2 texCoord22 = IN.ase_texcoord1.zw * float2( 1,1 ) + _LinesOffset;
				float2 temp_output_31_0_g45 = ( texCoord22 - float2( 1,1 ) );
				float2 appendResult39_g45 = (float2(frac( ( atan2( (temp_output_31_0_g45).x , (temp_output_31_0_g45).y ) / TWO_PI ) ) , length( temp_output_31_0_g45 )));
				float2 panner54_g45 = ( ( (temp_output_47_0_g45).x * _TimeParameters.x ) * float2( 1,0 ) + appendResult39_g45);
				float2 panner55_g45 = ( ( _TimeParameters.x * (temp_output_47_0_g45).y ) * float2( 0,1 ) + appendResult39_g45);
				...
				float4 break45_g41 = float4( 0,0,0,0 );
				float4 appendResult43_g41 = (float4(( break45_g41.z - _NoiseUv ) , break45_g41.w , 0.0 , 0.0));
				float2 texCoord51_g41 = IN.ase_texcoord1.zw * appendResult41_g41.xy + appendResult43_g41.xy;
				float2 panner46_g41 = ( ( _TimeParameters.x ) * _NoiseSpeed + texCoord51_g41);
				float simplePerlin2D16 = snoise( panner46_g41*_LinesSize );
				simplePerlin2D16 = simplePerlin2D16*0.5 + 0.5;
				float4 temp_cast_2 = (simplePerlin2D16).xxxx;
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;14;-1812.436,646.6044;Inherit;True;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;17;-2497.055,660.8793;Inherit;True;Tilling&Offset;-1;;41;31c9a21767af2f446848ac2df08d1f18;0;3;66;FLOAT4;1,1,1,0;False;67;FLOAT;-1;False;68;FLOAT2;0,-0.03;False;1;FLOAT2;0
Node;AmplifyShaderEditor.Vector2Node;18;-2731.568,832.5713;Float;False;Property;_NoiseSpeed;NoiseSpeed;6;0;Create;True;0;0;0;False;0;False;0,0.025;0.001,0.005;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;20;-2652.178,680.3952;Inherit;False;Property;_NoiseUv;NoiseUv;8;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;22;-3015.443,355.3877;Inherit;False;1;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0.5,0.5;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;26;-2792.953,166.6296;Inherit;True;RadialUVDistortion;-1;;45;051d65e7699b41a4c800363fd0e822b2;0;7;60;SAMPLER2D;_Sampler6026;False;1;FLOAT2;2.83,1;False;11;FLOAT2;0,0;False;65;FLOAT;1;False;68;FLOAT2;1,1;False;47;FLOAT2;0.08,0.43;False;29;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;31;-884.6445,472.6371;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;21;-2108.311,199.0386;Inherit;True;Property;_LinesPattern;LinesPattern;0;2;[Header];[NoScaleOffset];Create;True;2;LinesTxtr______________________________;;0;0;False;0;False;-1;a2e879e588630da4cbbf459a462a9ac2;a668eb9c00e8c1545b66c9b10fdfd7d9;True;1;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleSubtractOpNode;27;-993.509,996.2636;Inherit;False;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ClampOpNode;30;-927.504,820.3149;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;1,1,1,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;32;-1551.121,1022.19;Inherit;True;Property;_Mask;Mask;9;0;Create;True;0;0;0;False;0;False;-1;fe6df583013b9ad489e0a8b76aee51c2;fcf30e0fae112884b8cf5495dd7db92e;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;164.4547,483.6901;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;FSGShaders/sha_OverTime;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;3;True;12;all;0;False;True;1;5;False;;10;False;;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;2;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;;0;0;Standard;23;Surface;1;638205973862297787;  Blend;0;0;Two Sided;1;0;Forward Only;0;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;True;True;False;False;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;34;-26.81699,603.105;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;35;-341.7628,610.7183;Inherit;False;Property;_AlphaPower;AlphaPower;10;0;Create;True;0;0;0;False;0;False;0;0.406;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;36;-139.2552,818.3779;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.Vector2Node;25;-3140.885,77.82443;Inherit;False;Property;_LinesTextureCoordination;LinesTextureCoordination;1;0;Create;True;0;0;0;False;0;False;1,1;6,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;24;-3055.813,209.9986;Inherit;False;Property;_LinesTextureSpeed;LinesTextureSpeed;2;0;Create;True;0;0;0;False;0;False;0,0;0.001,0.5;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;23;-3236.952,524.0432;Inherit;False;Property;_LinesOffset;LinesOffset;3;0;Create;True;0;0;0;False;0;False;0.5,0.5;0.5,0.5;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector4Node;19;-2816.839,580.6912;Inherit;False;Property;_NoiseTO;NoiseTO;7;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;15;-2291.755,958.7822;Inherit;False;Property;_LinesSize;LinesSizeNoise;4;0;Create;True;0;0;0;False;0;False;0;15;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;16;-2035.044,662.5972;Inherit;False;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;12;-1531.903,473.6332;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;29;-1122.866,230.7477;Inherit;False;Property;_LinesColor;LinesColor;5;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.1698113,0.1545924,0.1545924,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ClampOpNode;13;-1264.987,480.8421;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;1,1,1,0;False;1;COLOR;0
WireConnection;14;0;21;0
WireConnection;14;1;16;0
WireConnection;17;66;19;0
WireConnection;17;67;20;0
WireConnection;17;68;18;0
WireConnection;22;1;23;0
WireConnection;26;68;25;0
WireConnection;26;47;24;0
WireConnection;26;29;22;0
...
ASEEND*/
//CHKSM=F91ACC4E6E97120A62E2B1AD8C840F300598FEDE